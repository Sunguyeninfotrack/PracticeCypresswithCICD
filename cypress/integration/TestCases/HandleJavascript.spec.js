describe('Example to demonstrate handling of JavaScript Alerts, Confirm, Prompt in Cypress', () => {
    ...
    it('Handling JS Alert - Validate Alert Text and Click OK', () => {
        ...
        cy.get('[id="result"]').contains('You successfuly clicked an alert')
    })

    it.only('Handling JS Confirm - Validate Confirm Text and Click OK', () => {
    ...
    it.only('Handling JS Confirm - Click Cancel', () => {
        cy.contains('Click for JS Confirm').click()
